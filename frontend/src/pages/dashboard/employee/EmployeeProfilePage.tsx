...
import EmployeeProfileSettings from '../../../components/dashboard/profile/employee/EmployeeProfileSettings';
import EmployeeSecuritySettings from '../../../components/dashboard/profile/employee/EmployeeSecuritySettings';
import EmployeeNotificationsSettings from '../../../components/dashboard/profile/employee/EmployeeNotificationsSettings';
import EmployeeConnectedApps from '../../../components/dashboard/profile/employee/EmployeeConnectedApps';
        ...
        <div className="h-full overflow-y-auto flex-1 p-4">
          <div className="mx-auto">
            <div className="bg-white rounded border border-gray-200">
              ...
              <div className="p-4">
                {activeTab === 'profile' && <EmployeeProfileSettings />}
                {activeTab === 'security' && <EmployeeSecuritySettings />}
                {activeTab === 'notifications' && <EmployeeNotificationsSettings />}
                {activeTab === 'connected-apps' && <EmployeeConnectedApps />}
              </div>
            </div>
          </div>
        </div>
