...
const DeleteConfirmModal = ({ isOpen, onClose, onConfirm, contract, getEmployeeName }) => {
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <div className="mb-6">
          <p className="text-gray-700">
            ...
            <span className="font-semibold">{getEmployeeName(contract.employeeId)}</span>? 
            This will permanently remove the contract and all associated data.
          </p>
        </div>
