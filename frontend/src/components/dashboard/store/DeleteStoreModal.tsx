...
const DeleteStoreModal = ({ isOpen, store, onClose, onDelete }: DeleteStoreModalProps) => {
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <div className="mb-6">
          <p className="text-gray-700">
            ...
            <span className="font-semibold">"{store.name}"</span>? This will permanently remove the store and all associated data.
          </p>
        </div>
