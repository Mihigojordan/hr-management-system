...
const DeleteAssetModal = ({ isOpen, asset, onClose, onDelete }: DeleteAssetModalProps) => {
            ...
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
                ...
                <div className="mb-6">
                    <p className="text-gray-700">
                        ...
                        <span className="font-semibold">"{asset.name}"</span>? This will permanently remove the asset and all associated data.
                    </p>
                </div>
