...
interface EditClientModalProps {
    ...
    onClose: () => void;
    client: Client | null;
    onSave: (data: UpdateClientInput) => Promise<void>;
}
...
const EditClientModal: React.FC<EditClientModalProps> = ({ isOpen, onClose, client, onSave }) => {
    ...
    const [imagePreview, setImagePreview] = useState<string | null>(client?.profileImage || null);
                ...
                <div className="relative bg-gradient-to-r from-orange-500 to-orange-600 rounded-t-2xl p-6 text-white">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-orange-100 text-sm mt-1">Update client profile details</p>
                        </div>
                        <button
                            onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <select
                            ...
                            onChange={handleChange}
                            className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-200 text-sm"
                        >
